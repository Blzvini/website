...
const games = [
  {
    ...
    nick: "とοﾆﾆοユΞΞΞΞΞ#ΞΞΞΞ",
    link: "https://op.gg/lol/summoners/br/%E3%81%A8%CE%BF%EF%BE%86%EF%BE%86%CE%BF%E3%83%A6%CE%9E%CE%9E%CE%9E%CE%9E%CE%9E-%CE%9E%CE%9E%CE%9E%CE%9E", // ex: 'https://www.op.gg/summoners/br/SEU_NICK-TAG'
    tagline: "Jungle diff",
...
const contacts = [
  ...
  },
  {
    ...
    link: "https://www.linkedin.com/in/blzvini/",
                ...
                <li key={game.id} className={styles.gameCard}>
                  {game.link ? (
                    <a
                      ...
                      aria-label={`${game.label} (abre em nova aba)`}
                      aria-describedby={`tip-game-${game.id}`}
                    >
                      {inner}
                    </a>
                  ) : (
